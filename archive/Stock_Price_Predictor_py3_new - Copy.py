...
if ensemble_svr_r2_score >0:
	test_plt.plot(test_dates,ensemble_svr_preds)
if ensemble_knr_r2_score >0:
	test_plt.plot(test_dates,ensemble_knr_preds)
if average_r2_score >0:
	test_plt.plot(test_dates,Average_test)
...
if average_r2_score>0:
	future_plt.plot(range(1,days +1),Average_future, label = 'average')
